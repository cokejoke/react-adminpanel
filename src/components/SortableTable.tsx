...
const useToolbarStyles = makeStyles((theme: Theme) =>
    createStyles({
        ...
        highlight: {
            color: indigo["500"],
            backgroundColor: lighten(indigo["500"], 0.85),
        },
        title: {
            flex: '1 1 100%',
        },
...
export default function EnhancedTable() {
    ...
    const [order, setOrder] = React.useState<SortType>('asc');
    ...
    const handleChangePage = (event: unknown, newPage: number) => {
        setPage(newPage);
        ServiceHolder.userService.getUsers(newPage, rowsPerPage).then((users: User[]) => {
            setRows(users);
        });
    };
    ...
    return (
        <div className={classes.root}>
            <Paper className={classes.paper}>
                ...
                <TablePagination
                    labelDisplayedRows={({ page }) => `${page + 1}/${Math.ceil(16 / 5)}`}
